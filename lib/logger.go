...
// InitLogger 初始化 log
func InitLogger(conf LogConfigs) (*zap.Logger, error) {
	...
	logger := zap.New(core, zap.AddCaller(), zap.AddCallerSkip(1)) // zap.Addcaller() 输出日志打印文件和行数如： logger/logger_test.go:33
